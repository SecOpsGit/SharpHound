...
using static Ingestor.CollectionMethod;
...
namespace Ingestor
{
    internal class Ingestor
    {
        public class Options
        {
            ...
            {
                   //  Dummy code to throw off call-stack analytics and hash based preventions.
                   //  Although some CSA done by ML will skip right past this, most MLs only 
                   //  carry general info about malicious stacks so it may throw it off enough 
                   //  to keep it under radar.
                   //
                   //  Function/Name analytics will still work on this unless we cause true process
                   //  misdirections/call-trees and also perform name mangling on our calls.
                   //
                var temp = 1 + 12 + Math.PI;
                var temp2 = temp - 16;
                temp = temp2;
                ...
                //
                var text = @"Ingestor v2.1.0
Usage: Ingestor.exe <options>
...
Cache Options
    ...
    --CacheFile (Default: <B64 Machine Sid>.bin)
        Filename for the IngestCache database to write to disk
...
";
        ...
        public static void InvokeIngestCache(string[] args)
        {
            Main(args);
        }
    }
